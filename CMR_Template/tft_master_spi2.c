...
//void beginCommandWrite(void){
//    _cs_low();
//    mPORTAClearBits(BIT_1);//set data line low
//    delay_us(1);
//    mPORTBSetBits(BIT_14);//rising clock edge
//    delay_us(1);
//    mPORTBClearBits(BIT_14);
//    delay_us(1);
//}
//
//void beginDataWrite(void){
//    _cs_low();
//    mPORTASetBits(BIT_1);//set data line high
//    delay_us(1);
//    mPORTBSetBits(BIT_14);//rising clock edge
//    delay_us(1);
//    mPORTBClearBits(BIT_14);
...
void tft_init_hw(void) {
  ...
  RPB1R = 3;               // SDO pin for SPI - goes to MOSI on TFT
  SDI1R = 0; // RA1      
}
...
void tft_begin(void) {
    mPORTASetPinsDigitalOut(BIT_1);//set SDO as digital out
